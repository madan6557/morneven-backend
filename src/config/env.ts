...
const schema = z.object({
  ...
  MIGRATION_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(900000),
  MIGRATION_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(5000),
...
export const env = {
  ...
  migrationRateLimitWindowMs: parsed.data.MIGRATION_RATE_LIMIT_WINDOW_MS,
  migrationRateLimitMax: parsed.data.MIGRATION_RATE_LIMIT_MAX,
